...
import { getFavorites, getFavoritesGames, getFavoritesNews, removeFavoriteGame, removeFavorites, removeFavoritesNews } from '../../Utils/actions'
...
function Notice({ notice, setLoading, toastRef, navigation, setRealoadData }) {
    ...
    const ConfirmRemoveFavorite = () => {
        Alert.alert(
            "Eliminar noticia de favoritos",
            "¿Estas seguro de querer eliminar la noticia de favoritos?",
            [
                {
                    text: "No",
                    style: "cancel"
